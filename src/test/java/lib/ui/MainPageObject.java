...
public class MainPageObject
{
    ...
    public void tryClickElementWithFewAttepmts(String locator, String error_message, int amount_of_attempts) {
    ...
    public boolean isElementLocatedOnTheScreen(String locator)
    {
        int element_location_by_y = this.waitForElementPresent(
                locator, "Cannot find element by locator", 10)
                .getLocation()
                .getY();
        if (Platform.getInstance().isMW()) {
            JavascriptExecutor JSExecutor = (JavascriptExecutor) driver;
    ...
    public void clickAboveTheElementInTheMiddle(String locator, String error_message)
    {
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method clickAboveTheElementInTheMiddle() does nothing for platform " + Platform.getInstance().getPlatformVar());
        }
